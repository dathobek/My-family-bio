            ...
            <Grid>
               ...
               <Row className="show-grid text-center">
                   <Col xs={12} sm={4} className="person-wrapper">
                     <Image src = "assets/davidA.jpeg" circle className="profile-pic" />
                     <h3>David</h3>
                   ...
                   <Col xs={12} sm={4} className="person-wrapper">
                     <Image src = "assets/Faith-nd-Abi.jpeg" circle className="profile-pic" />
                     <h3>Faith Nd Abigail</h3>
                     <p>Let your heart take you to wherever you want to be..Always Smile</p>
                   </Col>
                   <Col xs={12} sm={4} className="person-wrapper">
                     <Image src = "assets/emma.jpeg" circle className="profile-pic" />
                     <h3>Emmanuel</h3>
